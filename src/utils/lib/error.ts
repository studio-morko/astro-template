...
import { app }                    from '@root/app.config.ts';
...
export enum HTTPStatus {
  ...
  NotAcceptable               = 406, ProxyAuthRequired           = 407,
  ...
  UnavailableForLegalReasons  = 451, ServerError                 = 500,
  ...
  NotExtended                 = 510, NetworkAuthRequired         = 511
}
